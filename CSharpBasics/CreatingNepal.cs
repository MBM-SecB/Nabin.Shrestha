...
class CreatingNepal
{
    public void FolderNepal()
    {
        ...
        var dir = @"E:\Computer Science\.Net Centric Computing\Lab\Nabin.Shrestha\CSharpBasics\Nepal\Pokhara"; 
        ...
        var dir1 = @"E:\Computer Science\.Net Centric Computing\Lab\Nabin.Shrestha\CSharpBasics\Nepal\Kathmandu"; 
        if(!Directory.Exists(dir1))
        Directory.CreateDirectory(dir1);
        File.WriteAllText(Path.Combine(dir1, "test.txt"), "Kathmandu");


        var dir2 = @"E:\Computer Science\.Net Centric Computing\Lab\Nabin.Shrestha\CSharpBasics\Nepal\Bhaktapur";
        if(!Directory.Exists(dir2))
        Directory.CreateDirectory(dir2);
        File.WriteAllText(Path.Combine(dir2, "test.txt"), "Bhaktapur");


        var dir3 = @"E:\Computer Science\.Net Centric Computing\Lab\Nabin.Shrestha\CSharpBasics\Nepal\Lalitpur";  
        if(!Directory.Exists(dir3))
        Directory.CreateDirectory(dir3);
        File.WriteAllText(Path.Combine(dir3, "test.txt"), "Lalitpur");
        
        var dir4 = @"E:\Computer Science\.Net Centric Computing\Lab\Nabin.Shrestha\CSharpBasics\Nepal\Dolakha"; 
        if(!Directory.Exists(dir4))
        Directory.CreateDirectory(dir4);
        File.WriteAllText(Path.Combine(dir4, "test.txt"), "Dolakha");


        var dir5 = @"E:\Computer Science\.Net Centric Computing\Lab\Nabin.Shrestha\CSharpBasics\Nepal\Chitwan";
